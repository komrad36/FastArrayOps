...
CASE_96:
 vpmaxsw     ymm0,ymm1,yword [rdi-192]
 vpcmpeqw    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubw		 ymm4,ymm4,ymm2
CASE_80:
 vpmaxsw     ymm1,ymm0,yword [rdi-160]
 vpcmpeqw    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 vpsubw		 ymm4,ymm4,ymm2
CASE_64:
 vpmaxsw     ymm0,ymm1,yword [rdi-128]
 vpcmpeqw    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubw		 ymm4,ymm4,ymm2
CASE_48:
 vpmaxsw     ymm1,ymm0,yword [rdi-96]
 vpcmpeqw    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 vpsubw		 ymm4,ymm4,ymm2
CASE_32:
 vpmaxsw     ymm0,ymm1,yword [rdi-64]
 vpcmpeqw    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubw		 ymm4,ymm4,ymm2
CASE_16:
 vpmaxsw     ymm1,ymm0,yword [rdi-32]
 vpcmpeqw    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 lea		 edi,[rsi-16]
 vmovd		 xmm4,edi
...
CASE_6:
 lea		 ecx,[rsi-6]
 cmp		 r10w,word [r9-12]
 cmovl		 r10w,word [r9-12]
 cmovl		 eax,ecx
CASE_5:
 lea		 ecx,[rsi-5]
 cmp		 r10w,word [r9-10]
 cmovl		 r10w,word [r9-10]
 cmovl		 eax,ecx
CASE_4:
 lea		 ecx,[rsi-4]
 cmp		 r10w,word [r9-8]
 cmovl		 r10w,word [r9-8]
 cmovl		 eax,ecx
CASE_3:
 lea		 ecx,[rsi-3]
 cmp		 r10w,word [r9-6]
 cmovl		 r10w,word [r9-6]
 cmovl		 eax,ecx
CASE_2:
 lea		 ecx,[rsi-2]
 cmp		 r10w,word [r9-4]
 cmovl		 r10w,word [r9-4]
 cmovl		 eax,ecx
CASE_1:
 lea		 ecx,[rsi-1]
 cmp		 r10w,word [r9-2]
...
CASE_LARGE:
 ...
 vpmaxsw     ymm0,ymm10,yword [rdi+128]
 vpmaxsw     ymm1,ymm11,yword [rdi+160]
 vpmaxsw     ymm2,ymm12,yword [rdi+192]
 vpmaxsw     ymm3,ymm13,yword [rdi+224]
...
LOOP_TOP:
 vpmaxsw     ymm10,ymm0,yword [rdi-256]
 vpmaxsw     ymm11,ymm1,yword [rdi-224]
 vpmaxsw     ymm12,ymm2,yword [rdi-192]
 vpmaxsw     ymm13,ymm3,yword [rdi-160]
 vpcmpeqw    ymm0,ymm0,ymm10
 vpblendvb   ymm5,ymm4,ymm5,ymm0
 vpmaxsw     ymm0,ymm10,yword [rdi-128]
 vpcmpeqw    ymm1,ymm1,ymm11
 vpblendvb   ymm6,ymm4,ymm6,ymm1
 vpmaxsw     ymm1,ymm11,yword [rdi-96]
 vpcmpeqw    ymm2,ymm2,ymm12
 vpblendvb   ymm7,ymm4,ymm7,ymm2
 vpmaxsw     ymm2,ymm12,yword [rdi-64]
 vpcmpeqw    ymm3,ymm3,ymm13
 vpblendvb   ymm8,ymm4,ymm8,ymm3
 vpmaxsw     ymm3,ymm13,yword [rdi-32]
 vpsubw      ymm4,ymm4,ymm9
 vpcmpeqw    ymm10,ymm0,ymm10
 vpblendvb   ymm5,ymm4,ymm5,ymm10
 vpcmpeqw    ymm11,ymm1,ymm11
...
LOOP_END:
 ...
 vpmaxsw     ymm10,ymm0,yword [rsi-256]
 vpmaxsw     ymm11,ymm1,yword [rsi-224]
 vpmaxsw     ymm12,ymm2,yword [rsi-192]
 vpmaxsw     ymm13,ymm3,yword [rsi-160]
 vpcmpeqw    ymm0,ymm0,ymm10
 vpblendvb   ymm5,ymm4,ymm5,ymm0
 vpmaxsw     ymm0,ymm10,yword [rsi-128]
 vpcmpeqw    ymm1,ymm1,ymm11
 vpblendvb   ymm6,ymm4,ymm6,ymm1
 vpmaxsw     ymm1,ymm11,yword [rsi-96]
 vpcmpeqw    ymm2,ymm2,ymm12
 vpblendvb   ymm7,ymm4,ymm7,ymm2
 vpmaxsw     ymm2,ymm12,yword [rsi-64]
 vpcmpeqw    ymm3,ymm3,ymm13
 vpblendvb   ymm8,ymm4,ymm8,ymm3
 vpmaxsw     ymm3,ymm13,yword [rsi-32]
 vpsubw      ymm4,ymm4,ymm9
 vpcmpeqw    ymm13,ymm3,ymm13
 vpblendvb   ymm8,ymm4,ymm8,ymm13
...
INNER_LOOP_END:
 ...
 vpmaxsw     ymm0,ymm5,yword [rsi-128]
 vpmaxsw     ymm1,ymm6,yword [rsi-96]
 vpmaxsw     ymm2,ymm7,yword [rsi-64]
 vpmaxsw     ymm3,ymm8,yword [rsi-32]
