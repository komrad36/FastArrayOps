...
CASE_10:
 ...
 cmova       rax,qword [rsi-80]
CASE_9:
 cmp         rax,qword [rsi-72]
 cmova       rax,qword [rsi-72]
CASE_8:
 cmp         rax,qword [rsi-64]
 cmova       rax,qword [rsi-64]
CASE_7:
 cmp         rax,qword [rsi-56]
 cmova       rax,qword [rsi-56]
CASE_6:
 cmp         rax,qword [rsi-48]
 cmova       rax,qword [rsi-48]
CASE_5:
 cmp         rax,qword [rsi-40]
 cmova       rax,qword [rsi-40]
CASE_4:
 cmp         rax,qword [rsi-32]
 cmova       rax,qword [rsi-32]
CASE_3:
 cmp         rax,qword [rsi-24]
 cmova       rax,qword [rsi-24]
CASE_2:
 cmp         rax,qword [rsi-16]
 cmova       rax,qword [rsi-16]
CASE_1:
 cmp         rax,qword [rsi-8]
 cmova       rax,qword [rsi-8]
CASE_0:
 ret
