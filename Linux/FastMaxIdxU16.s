...
CASE_LARGE:
 ...
 vpmaxuw     ymm0,ymm10,yword [rdi+128]
 vpmaxuw     ymm1,ymm11,yword [rdi+160]
 vpmaxuw     ymm2,ymm12,yword [rdi+192]
 vpmaxuw     ymm3,ymm13,yword [rdi+224]
...
LOOP_TOP:
 vpmaxuw     ymm10,ymm0,yword [rdi-256]
 vpmaxuw     ymm11,ymm1,yword [rdi-224]
 vpmaxuw     ymm12,ymm2,yword [rdi-192]
 vpmaxuw     ymm13,ymm3,yword [rdi-160]
 vpcmpeqw    ymm0,ymm0,ymm10
 vpblendvb   ymm5,ymm4,ymm5,ymm0
 vpmaxuw     ymm0,ymm10,yword [rdi-128]
 vpcmpeqw    ymm1,ymm1,ymm11
 vpblendvb   ymm6,ymm4,ymm6,ymm1
 vpmaxuw     ymm1,ymm11,yword [rdi-96]
 vpcmpeqw    ymm2,ymm2,ymm12
 vpblendvb   ymm7,ymm4,ymm7,ymm2
 vpmaxuw     ymm2,ymm12,yword [rdi-64]
 vpcmpeqw    ymm3,ymm3,ymm13
 vpblendvb   ymm8,ymm4,ymm8,ymm3
 vpmaxuw     ymm3,ymm13,yword [rdi-32]
 vpsubw      ymm4,ymm4,ymm9
 vpcmpeqw    ymm10,ymm0,ymm10
 vpblendvb   ymm5,ymm4,ymm5,ymm10
 vpcmpeqw    ymm11,ymm1,ymm11
...
LOOP_END:
 ...
 vpmaxuw     ymm12,ymm2,yword [rsi-192]
 vpmaxuw     ymm13,ymm3,yword [rsi-160]
 vpcmpeqw    ymm0,ymm0,ymm10
 vpblendvb   ymm5,ymm4,ymm5,ymm0
 vpmaxuw     ymm0,ymm10,yword [rsi-128]
 vpcmpeqw    ymm1,ymm1,ymm11
 vpblendvb   ymm6,ymm4,ymm6,ymm1
 vpmaxuw     ymm1,ymm11,yword [rsi-96]
 vpcmpeqw    ymm2,ymm2,ymm12
 vpblendvb   ymm7,ymm4,ymm7,ymm2
 vpmaxuw     ymm2,ymm12,yword [rsi-64]
 vpcmpeqw    ymm3,ymm3,ymm13
 vpblendvb   ymm8,ymm4,ymm8,ymm3
 vpmaxuw     ymm3,ymm13,yword [rsi-32]
 vpsubw      ymm4,ymm4,ymm9
 vpcmpeqw    ymm13,ymm3,ymm13
 vpblendvb   ymm8,ymm4,ymm8,ymm13
...
INNER_LOOP_END:
 ...
 vpmaxuw     ymm0,ymm5,yword [rsi-128]
 vpmaxuw     ymm1,ymm6,yword [rsi-96]
 vpmaxuw     ymm2,ymm7,yword [rsi-64]
 vpmaxuw     ymm3,ymm8,yword [rsi-32]
