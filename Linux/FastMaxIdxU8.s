...
CASE_192:
 vpmaxub     ymm0,ymm1,yword [rdi-192]
 vpcmpeqb    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubb		 ymm4,ymm4,ymm2
CASE_160:
 vpmaxub     ymm1,ymm0,yword [rdi-160]
 vpcmpeqb    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 vpsubb		 ymm4,ymm4,ymm2
CASE_128:
 vpmaxub     ymm0,ymm1,yword [rdi-128]
 vpcmpeqb    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubb		 ymm4,ymm4,ymm2
CASE_96:
 vpmaxub     ymm1,ymm0,yword [rdi-96]
 vpcmpeqb    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 vpsubb		 ymm4,ymm4,ymm2
CASE_64:
 vpmaxub     ymm0,ymm1,yword [rdi-64]
 vpcmpeqb    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubb		 ymm4,ymm4,ymm2
CASE_32:
 vpmaxub     ymm1,ymm0,yword [rdi-32]
 vpcmpeqb    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 lea		 edi,[rsi-32]
 vmovd		 xmm4,edi
...
LOOP_TOP:
 ...
 vpmaxub     ymm0,ymm4,yword [rdi-128]
 vpmaxub     ymm1,ymm5,yword [rdi-96]
 vpmaxub     ymm2,ymm6,yword [rdi-64]
 vpmaxub     ymm3,ymm7,yword [rdi-32]
...
LOOP_END:
 ...
 vpmaxub     ymm0,ymm4,yword [rsi-128]
 vpmaxub     ymm1,ymm5,yword [rsi-96]
 vpmaxub     ymm2,ymm6,yword [rsi-64]
 vpmaxub     ymm3,ymm7,yword [rsi-32]
 vpcmpeqb    ymm4,ymm0,ymm4
 vpcmpeqb    ymm5,ymm1,ymm5
 vpcmpeqb    ymm6,ymm2,ymm6
 vpcmpeqb    ymm7,ymm3,ymm7
...
INNER_LOOP_END:
 ...
 vpmaxub	 ymm1,ymm0,yword [rsp+64]
 vpcmpeqb    ymm0,ymm0,ymm1
 ...
 vpmaxub	 ymm0,ymm1,yword [rsp+64]
 vpcmpeqb    ymm1,ymm0,ymm1
 vpunpcklbw  ymm1,ymm1,ymm1
