...
CASE_24:
 vmaxpd      ymm0,ymm1,yword [rdi-192]
 vpcmpeqq    ymm1,ymm0,ymm1
 vpblendvb   ymm2,ymm3,ymm2,ymm1
 vpsubq      ymm3,ymm3,ymm5
CASE_20:
 vmaxpd      ymm1,ymm0,yword [rdi-160]
 vpcmpeqq    ymm0,ymm0,ymm1
 vpblendvb   ymm2,ymm3,ymm2,ymm0
 vpsubq      ymm3,ymm3,ymm5
CASE_16:
 vmaxpd      ymm0,ymm1,yword [rdi-128]
 vpcmpeqq    ymm1,ymm0,ymm1
 vpblendvb   ymm2,ymm3,ymm2,ymm1
 vpsubq      ymm3,ymm3,ymm5
CASE_12:
 vmaxpd      ymm1,ymm0,yword [rdi-96]
 vpcmpeqq    ymm0,ymm0,ymm1
 vpblendvb   ymm2,ymm3,ymm2,ymm0
 vpsubq      ymm3,ymm3,ymm5
CASE_8:
 vmaxpd      ymm0,ymm1,yword [rdi-64]
 vpcmpeqq    ymm1,ymm0,ymm1
 vpblendvb   ymm2,ymm3,ymm2,ymm1
 vpsubq      ymm3,ymm3,ymm5
CASE_4:
 vmaxpd      ymm1,ymm0,yword [rdi-32]
 vpcmpeqq    ymm0,ymm0,ymm1
 vpblendvb   ymm2,ymm3,ymm2,ymm0
 lea         edi,[r9-4]
 vmovd       xmm3,edi
...
CASE_LARGE:
 ...
 vmaxpd      ymm0,ymm8,yword [rdi+128]
 vmaxpd      ymm1,ymm9,yword [rdi+160]
 vmaxpd      ymm2,ymm10,yword [rdi+192]
 vmaxpd      ymm3,ymm11,yword [rdi+224]
...
LOOP_TOP:
 vmaxpd      ymm8,ymm0,yword [rdi-256]
 vmaxpd      ymm9,ymm1,yword [rdi-224]
 vmaxpd      ymm10,ymm2,yword [rdi-192]
 vmaxpd      ymm11,ymm3,yword [rdi-160]
 vpcmpeqq    ymm0,ymm0,ymm8
 vpcmpeqq    ymm1,ymm1,ymm9
 vpackssdw   ymm1,ymm0,ymm1
 vpblendvb   ymm5,ymm4,ymm5,ymm1
 vmaxpd      ymm0,ymm8,yword [rdi-128]
 vmaxpd      ymm1,ymm9,yword [rdi-96]
 vpcmpeqq    ymm2,ymm2,ymm10
 vpcmpeqq    ymm3,ymm3,ymm11
 vpackssdw   ymm3,ymm2,ymm3
 vpblendvb   ymm6,ymm4,ymm6,ymm3
 vmaxpd      ymm2,ymm10,yword [rdi-64]
 vmaxpd      ymm3,ymm11,yword [rdi-32]
 vpsubd      ymm4,ymm4,ymm7
 vpcmpeqq    ymm8,ymm0,ymm8
 vpcmpeqq    ymm9,ymm1,ymm9
 vpackssdw   ymm8,ymm8,ymm9
...
LOOP_END:
 ...
 vmaxpd      ymm8,ymm0,yword [rsi-256]
 vmaxpd      ymm9,ymm1,yword [rsi-224]
 vmaxpd      ymm10,ymm2,yword [rsi-192]
 vmaxpd      ymm11,ymm3,yword [rsi-160]
 vpcmpeqq    ymm0,ymm0,ymm8
 vpcmpeqq    ymm1,ymm1,ymm9
 vpackssdw   ymm1,ymm0,ymm1
 vpblendvb   ymm5,ymm4,ymm5,ymm1
 vmaxpd      ymm0,ymm8,yword [rsi-128]
 vmaxpd      ymm1,ymm9,yword [rsi-96]
 vpcmpeqq    ymm2,ymm2,ymm10
 vpcmpeqq    ymm3,ymm3,ymm11
 vpackssdw   ymm3,ymm2,ymm3
 vpblendvb   ymm6,ymm4,ymm6,ymm3
 vmaxpd      ymm2,ymm10,yword [rsi-64]
 vmaxpd      ymm3,ymm11,yword [rsi-32]
 vpsubd      ymm4,ymm4,ymm7
 vpcmpeqq    ymm10,ymm2,ymm10
 vpcmpeqq    ymm11,ymm3,ymm11
 vpackssdw   ymm10,ymm10,ymm11
