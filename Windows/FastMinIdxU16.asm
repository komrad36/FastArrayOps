_TEXT$AsmFastMinIdxU16 SEGMENT ALIGN(64)

AsmFastMinIdxU16 PROC
 sub         rsp,136
...
CASE_96:
 vpminuw     ymm0,ymm1,ymmword ptr [rcx-192]
 vpcmpeqw    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubw      ymm4,ymm4,ymm2
CASE_80:
 vpminuw     ymm1,ymm0,ymmword ptr [rcx-160]
 vpcmpeqw    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 vpsubw      ymm4,ymm4,ymm2
CASE_64:
 vpminuw     ymm0,ymm1,ymmword ptr [rcx-128]
 vpcmpeqw    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubw      ymm4,ymm4,ymm2
CASE_48:
 vpminuw     ymm1,ymm0,ymmword ptr [rcx-96]
 vpcmpeqw    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 vpsubw      ymm4,ymm4,ymm2
CASE_32:
 vpminuw     ymm0,ymm1,ymmword ptr [rcx-64]
 vpcmpeqw    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubw      ymm4,ymm4,ymm2
CASE_16:
 vpminuw     ymm1,ymm0,ymmword ptr [rcx-32]
 vpcmpeqw    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 lea         ecx,[rdx-16]
 vmovd       xmm4,ecx
 ...
 vpminuw     ymm0,ymm1,ymmword ptr [r9-32]
 vpcmpeqw    ymm1,ymm0,ymm1
 ...
 ret
CASE_8:
 vpminuw     xmm1,xmm0,xmmword ptr [rcx]
 ...
 vpminuw     xmm0,xmm1,xmmword ptr [r9-16]
 vpcmpeqw    xmm1,xmm0,xmm1
...
CASE_6:
 ...
 cmova       r10w,word ptr [r9-12]
 cmova       eax,ecx
CASE_5:
 lea         ecx,[rdx-5]
 cmp         r10w,word ptr [r9-10]
 cmova       r10w,word ptr [r9-10]
 cmova       eax,ecx
CASE_4:
 lea         ecx,[rdx-4]
 cmp         r10w,word ptr [r9-8]
 cmova       r10w,word ptr [r9-8]
 cmova       eax,ecx
CASE_3:
 lea         ecx,[rdx-3]
 cmp         r10w,word ptr [r9-6]
 cmova       r10w,word ptr [r9-6]
 cmova       eax,ecx
CASE_2:
 lea         ecx,[rdx-2]
 cmp         r10w,word ptr [r9-4]
 cmova       r10w,word ptr [r9-4]
 cmova       eax,ecx
CASE_1:
 lea         ecx,[rdx-1]
...
CASE_LARGE:
 ...
 vpminuw     ymm0,ymm10,ymmword ptr [rcx+128]
 vpminuw     ymm1,ymm11,ymmword ptr [rcx+160]
 vpminuw     ymm2,ymm12,ymmword ptr [rcx+192]
 vpminuw     ymm3,ymm13,ymmword ptr [rcx+224]
...
LOOP_TOP:
 vpminuw     ymm10,ymm0,ymmword ptr [rcx-256]
 vpminuw     ymm11,ymm1,ymmword ptr [rcx-224]
 vpminuw     ymm12,ymm2,ymmword ptr [rcx-192]
 vpminuw     ymm13,ymm3,ymmword ptr [rcx-160]
 vpcmpeqw    ymm0,ymm0,ymm10
 vpblendvb   ymm5,ymm4,ymm5,ymm0
 vpminuw     ymm0,ymm10,ymmword ptr [rcx-128]
 vpcmpeqw    ymm1,ymm1,ymm11
 vpblendvb   ymm6,ymm4,ymm6,ymm1
 vpminuw     ymm1,ymm11,ymmword ptr [rcx-96]
 vpcmpeqw    ymm2,ymm2,ymm12
 vpblendvb   ymm7,ymm4,ymm7,ymm2
 vpminuw     ymm2,ymm12,ymmword ptr [rcx-64]
 vpcmpeqw    ymm3,ymm3,ymm13
 vpblendvb   ymm8,ymm4,ymm8,ymm3
 vpminuw     ymm3,ymm13,ymmword ptr [rcx-32]
 vpsubw      ymm4,ymm4,ymm9
 vpcmpeqw    ymm10,ymm0,ymm10
 vpblendvb   ymm5,ymm4,ymm5,ymm10
 vpcmpeqw    ymm11,ymm1,ymm11
...
LOOP_END:
 ...
 vpminuw     ymm10,ymm0,ymmword ptr [rdx-256]
 vpminuw     ymm11,ymm1,ymmword ptr [rdx-224]
 vpminuw     ymm12,ymm2,ymmword ptr [rdx-192]
 vpminuw     ymm13,ymm3,ymmword ptr [rdx-160]
 vpcmpeqw    ymm0,ymm0,ymm10
 vpblendvb   ymm5,ymm4,ymm5,ymm0
 vpminuw     ymm0,ymm10,ymmword ptr [rdx-128]
 vpcmpeqw    ymm1,ymm1,ymm11
 vpblendvb   ymm6,ymm4,ymm6,ymm1
 vpminuw     ymm1,ymm11,ymmword ptr [rdx-96]
 vpcmpeqw    ymm2,ymm2,ymm12
 vpblendvb   ymm7,ymm4,ymm7,ymm2
 vpminuw     ymm2,ymm12,ymmword ptr [rdx-64]
 vpcmpeqw    ymm3,ymm3,ymm13
 vpblendvb   ymm8,ymm4,ymm8,ymm3
 vpminuw     ymm3,ymm13,ymmword ptr [rdx-32]
 vpsubw      ymm4,ymm4,ymm9
 vpcmpeqw    ymm13,ymm3,ymm13
 vpblendvb   ymm8,ymm4,ymm8,ymm13
...
INNER_LOOP_END:
 ...
 vpminuw     ymm0,ymm5,ymmword ptr [rdx-128]
 vpminuw     ymm1,ymm6,ymmword ptr [rdx-96]
 vpminuw     ymm2,ymm7,ymmword ptr [rdx-64]
 vpminuw     ymm3,ymm8,ymmword ptr [rdx-32]
...
AsmFastMinIdxU16 ENDP

_TEXT$AsmFastMinIdxU16 ENDS
