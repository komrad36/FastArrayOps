_TEXT$AsmFastMaxIdxI32 SEGMENT ALIGN(64)

AsmFastMaxIdxI32 PROC
 sub		 rsp,104
...
CASE_48:
 vpmaxsd     ymm0,ymm1,ymmword ptr [rcx-192]
 vpcmpeqd    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubd		 ymm4,ymm4,ymm2
CASE_40:
 vpmaxsd     ymm1,ymm0,ymmword ptr [rcx-160]
 vpcmpeqd    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 vpsubd		 ymm4,ymm4,ymm2
CASE_32:
 vpmaxsd     ymm0,ymm1,ymmword ptr [rcx-128]
 vpcmpeqd    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubd		 ymm4,ymm4,ymm2
CASE_24:
 vpmaxsd     ymm1,ymm0,ymmword ptr [rcx-96]
 vpcmpeqd    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 vpsubd		 ymm4,ymm4,ymm2
CASE_16:
 vpmaxsd     ymm0,ymm1,ymmword ptr [rcx-64]
 vpcmpeqd    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubd		 ymm4,ymm4,ymm2
CASE_8:
 vpmaxsd     ymm1,ymm0,ymmword ptr [rcx-32]
 vpcmpeqd    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 lea		 ecx,[rdx-8]
 vmovd		 xmm4,ecx
 ...
 vpmaxsd     ymm0,ymm1,ymmword ptr [r9-32]
 vpcmpeqd    ymm1,ymm0,ymm1
...
CASE_6:
 ...
 cmovl		 r10d,dword ptr [r9-24]
 cmovl		 eax,ecx
CASE_5:
 lea		 ecx,[rdx-5]
 cmp		 r10d,dword ptr [r9-20]
 cmovl		 r10d,dword ptr [r9-20]
 cmovl		 eax,ecx
CASE_4:
 lea		 ecx,[rdx-4]
 cmp		 r10d,dword ptr [r9-16]
 cmovl		 r10d,dword ptr [r9-16]
 cmovl		 eax,ecx
CASE_3:
 lea		 ecx,[rdx-3]
 cmp		 r10d,dword ptr [r9-12]
 cmovl		 r10d,dword ptr [r9-12]
 cmovl		 eax,ecx
CASE_2:
 lea		 ecx,[rdx-2]
 cmp		 r10d,dword ptr [r9-8]
 cmovl		 r10d,dword ptr [r9-8]
 cmovl		 eax,ecx
CASE_1:
 lea		 ecx,[rdx-1]
...
CASE_LARGE:
 ...
 vpmaxsd     ymm0,ymm10,ymmword ptr [rcx+128]
 vpmaxsd     ymm1,ymm11,ymmword ptr [rcx+160]
 vpmaxsd     ymm2,ymm12,ymmword ptr [rcx+192]
 vpmaxsd     ymm3,ymm13,ymmword ptr [rcx+224]
...
LOOP_TOP:
 vpmaxsd     ymm10,ymm0,ymmword ptr [rcx-256]
 vpmaxsd     ymm11,ymm1,ymmword ptr [rcx-224]
 vpmaxsd     ymm12,ymm2,ymmword ptr [rcx-192]
 vpmaxsd     ymm13,ymm3,ymmword ptr [rcx-160]
 vpcmpeqd    ymm0,ymm0,ymm10
 vpblendvb   ymm5,ymm4,ymm5,ymm0
 vpmaxsd     ymm0,ymm10,ymmword ptr [rcx-128]
 vpcmpeqd    ymm1,ymm1,ymm11
 vpblendvb   ymm6,ymm4,ymm6,ymm1
 vpmaxsd     ymm1,ymm11,ymmword ptr [rcx-96]
 vpcmpeqd    ymm2,ymm2,ymm12
 vpblendvb   ymm7,ymm4,ymm7,ymm2
 vpmaxsd     ymm2,ymm12,ymmword ptr [rcx-64]
 vpcmpeqd    ymm3,ymm3,ymm13
 vpblendvb   ymm8,ymm4,ymm8,ymm3
 vpmaxsd     ymm3,ymm13,ymmword ptr [rcx-32]
 vpsubd      ymm4,ymm4,ymm9
 vpcmpeqd    ymm10,ymm0,ymm10
 vpblendvb   ymm5,ymm4,ymm5,ymm10
 vpcmpeqd    ymm11,ymm1,ymm11
...
LOOP_END:
 ...
 vpmaxsd     ymm10,ymm0,ymmword ptr [rdx-256]
 vpmaxsd     ymm11,ymm1,ymmword ptr [rdx-224]
 vpmaxsd     ymm12,ymm2,ymmword ptr [rdx-192]
 vpmaxsd     ymm13,ymm3,ymmword ptr [rdx-160]
 vpcmpeqd    ymm0,ymm0,ymm10
 vpblendvb   ymm5,ymm4,ymm5,ymm0
 vpmaxsd     ymm0,ymm10,ymmword ptr [rdx-128]
 vpcmpeqd    ymm1,ymm1,ymm11
 vpblendvb   ymm6,ymm4,ymm6,ymm1
 vpmaxsd     ymm1,ymm11,ymmword ptr [rdx-96]
 vpcmpeqd    ymm2,ymm2,ymm12
 vpblendvb   ymm7,ymm4,ymm7,ymm2
 vpmaxsd     ymm2,ymm12,ymmword ptr [rdx-64]
 vpcmpeqd    ymm3,ymm3,ymm13
 vpblendvb   ymm8,ymm4,ymm8,ymm3
 vpmaxsd     ymm3,ymm13,ymmword ptr [rdx-32]
 vpsubd      ymm4,ymm4,ymm9
 vpcmpeqd    ymm13,ymm3,ymm13
 vpblendvb   ymm8,ymm4,ymm8,ymm13
 ...
 add         rsp,104
 ret
AsmFastMaxIdxI32 ENDP

_TEXT$AsmFastMaxIdxI32 ENDS
