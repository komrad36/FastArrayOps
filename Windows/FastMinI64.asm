...
CASE_16:
 vpcmpgtq    ymm4,ymm1,ymmword ptr [rcx-128]
 vpblendvb   ymm1,ymm1,ymmword ptr [rcx-128],ymm4
CASE_12:
 vpcmpgtq    ymm4,ymm0,ymmword ptr [rcx-96]
 vpblendvb   ymm0,ymm0,ymmword ptr [rcx-96],ymm4
 vpcmpgtq    ymm4,ymm1,ymmword ptr [rcx-64]
 vpblendvb   ymm1,ymm1,ymmword ptr [rcx-64],ymm4
 vpcmpgtq    ymm4,ymm0,ymmword ptr [rcx-32]
 vpblendvb   ymm0,ymm0,ymmword ptr [rcx-32],ymm4
 vpcmpgtq    ymm4,ymm1,ymmword ptr [rdx-32]
 vpblendvb   ymm1,ymm1,ymmword ptr [rdx-32],ymm4
 jmp GATHER_1
CASE_11:
 mov         rax,qword ptr [rdx-88]
CASE_10:
 cmp         rax,qword ptr [rdx-80]
 cmovg       rax,qword ptr [rdx-80]
CASE_9:
 cmp         rax,qword ptr [rdx-72]
 cmovg       rax,qword ptr [rdx-72]
CASE_8:
 cmp         rax,qword ptr [rdx-64]
 cmovg       rax,qword ptr [rdx-64]
CASE_7:
 cmp         rax,qword ptr [rdx-56]
 cmovg       rax,qword ptr [rdx-56]
CASE_6:
 cmp         rax,qword ptr [rdx-48]
 cmovg       rax,qword ptr [rdx-48]
CASE_5:
 cmp         rax,qword ptr [rdx-40]
 cmovg       rax,qword ptr [rdx-40]
CASE_4:
 cmp         rax,qword ptr [rdx-32]
 cmovg       rax,qword ptr [rdx-32]
CASE_3:
 cmp         rax,qword ptr [rdx-24]
 cmovg       rax,qword ptr [rdx-24]
CASE_2:
 cmp         rax,qword ptr [rdx-16]
 cmovg       rax,qword ptr [rdx-16]
CASE_1:
