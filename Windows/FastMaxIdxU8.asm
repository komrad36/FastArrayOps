_TEXT$AsmFastMaxIdxU8 SEGMENT ALIGN(64)

AsmFastMaxIdxU8 PROC
 sub         rsp,200
...
CASE_192:
 vpmaxub     ymm0,ymm1,ymmword ptr [rcx-192]
 vpcmpeqb    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubb      ymm4,ymm4,ymm2
CASE_160:
 vpmaxub     ymm1,ymm0,ymmword ptr [rcx-160]
 vpcmpeqb    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 vpsubb      ymm4,ymm4,ymm2
CASE_128:
 vpmaxub     ymm0,ymm1,ymmword ptr [rcx-128]
 vpcmpeqb    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubb      ymm4,ymm4,ymm2
CASE_96:
 vpmaxub     ymm1,ymm0,ymmword ptr [rcx-96]
 vpcmpeqb    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 vpsubb      ymm4,ymm4,ymm2
CASE_64:
 vpmaxub     ymm0,ymm1,ymmword ptr [rcx-64]
 vpcmpeqb    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubb      ymm4,ymm4,ymm2
CASE_32:
 vpmaxub     ymm1,ymm0,ymmword ptr [rcx-32]
 vpcmpeqb    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 lea         ecx,[rdx-32]
 vmovd       xmm4,ecx
 ...
 vpmaxub     ymm0,ymm1,ymmword ptr [r9-32]
 vpcmpeqb    ymm1,ymm0,ymm1
...
CASE_16:
 ...
 vpmaxub     xmm0,xmm1,xmmword ptr [r9-16]
 vpcmpeqb    xmm1,xmm0,xmm1
...
LOOP_TOP:
 ...
 vpmaxub     ymm0,ymm4,ymmword ptr [rcx-128]
 vpmaxub     ymm1,ymm5,ymmword ptr [rcx-96]
 vpmaxub     ymm2,ymm6,ymmword ptr [rcx-64]
 vpmaxub     ymm3,ymm7,ymmword ptr [rcx-32]
...
LOOP_END:
 ...
 vpmaxub     ymm0,ymm4,ymmword ptr [rdx-128]
 vpmaxub     ymm1,ymm5,ymmword ptr [rdx-96]
 vpmaxub     ymm2,ymm6,ymmword ptr [rdx-64]
 vpmaxub     ymm3,ymm7,ymmword ptr [rdx-32]
 vpcmpeqb    ymm4,ymm0,ymm4
 vpcmpeqb    ymm5,ymm1,ymm5
 vpcmpeqb    ymm6,ymm2,ymm6
 vpcmpeqb    ymm7,ymm3,ymm7
...
CASE_VERY_LARGE:
 ...
 ; 8-bit outer best value (0)
 vmovdqu     ymmword ptr [rsp+160],ymm10
...
INNER_LOOP_END:
 ...
 vpmaxub     ymm1,ymm0,ymmword ptr [rsp+160]
 vpcmpeqb    ymm0,ymm0,ymm1
 ...
 vpmaxub     ymm0,ymm1,ymmword ptr [rsp+160]
 vpcmpeqb    ymm1,ymm0,ymm1
 vpunpcklbw  ymm1,ymm1,ymm1
...
AsmFastMaxIdxU8 ENDP

_TEXT$AsmFastMaxIdxU8 ENDS
