_TEXT$AsmFastMaxIdxU32 SEGMENT ALIGN(64)

AsmFastMaxIdxU32 PROC
 sub		 rsp,104
...
CASE_48:
 vpmaxud     ymm0,ymm1,ymmword ptr [rcx-192]
 vpcmpeqd    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubd		 ymm4,ymm4,ymm2
CASE_40:
 vpmaxud     ymm1,ymm0,ymmword ptr [rcx-160]
 vpcmpeqd    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 vpsubd		 ymm4,ymm4,ymm2
CASE_32:
 vpmaxud     ymm0,ymm1,ymmword ptr [rcx-128]
 vpcmpeqd    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubd		 ymm4,ymm4,ymm2
CASE_24:
 vpmaxud     ymm1,ymm0,ymmword ptr [rcx-96]
 vpcmpeqd    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 vpsubd		 ymm4,ymm4,ymm2
CASE_16:
 vpmaxud     ymm0,ymm1,ymmword ptr [rcx-64]
 vpcmpeqd    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubd		 ymm4,ymm4,ymm2
CASE_8:
 vpmaxud     ymm1,ymm0,ymmword ptr [rcx-32]
 vpcmpeqd    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 lea		 ecx,[rdx-8]
 vmovd		 xmm4,ecx
 ...
 vpmaxud     ymm0,ymm1,ymmword ptr [r9-32]
 vpcmpeqd    ymm1,ymm0,ymm1
...
CASE_6:
 ...
 cmovb		 r10d,dword ptr [r9-24]
 cmovb		 eax,ecx
CASE_5:
 lea		 ecx,[rdx-5]
 cmp		 r10d,dword ptr [r9-20]
 cmovb		 r10d,dword ptr [r9-20]
 cmovb		 eax,ecx
CASE_4:
 lea		 ecx,[rdx-4]
 cmp		 r10d,dword ptr [r9-16]
 cmovb		 r10d,dword ptr [r9-16]
 cmovb		 eax,ecx
CASE_3:
 lea		 ecx,[rdx-3]
 cmp		 r10d,dword ptr [r9-12]
 cmovb		 r10d,dword ptr [r9-12]
 cmovb		 eax,ecx
CASE_2:
 lea		 ecx,[rdx-2]
 cmp		 r10d,dword ptr [r9-8]
 cmovb		 r10d,dword ptr [r9-8]
 cmovb		 eax,ecx
CASE_1:
 lea		 ecx,[rdx-1]
...
CASE_LARGE:
 ...
 vpmaxud     ymm0,ymm10,ymmword ptr [rcx+128]
 vpmaxud     ymm1,ymm11,ymmword ptr [rcx+160]
 vpmaxud     ymm2,ymm12,ymmword ptr [rcx+192]
 vpmaxud     ymm3,ymm13,ymmword ptr [rcx+224]
...
LOOP_TOP:
 vpmaxud     ymm10,ymm0,ymmword ptr [rcx-256]
 vpmaxud     ymm11,ymm1,ymmword ptr [rcx-224]
 vpmaxud     ymm12,ymm2,ymmword ptr [rcx-192]
 vpmaxud     ymm13,ymm3,ymmword ptr [rcx-160]
 vpcmpeqd    ymm0,ymm0,ymm10
 vpblendvb   ymm5,ymm4,ymm5,ymm0
 vpmaxud     ymm0,ymm10,ymmword ptr [rcx-128]
 vpcmpeqd    ymm1,ymm1,ymm11
 vpblendvb   ymm6,ymm4,ymm6,ymm1
 vpmaxud     ymm1,ymm11,ymmword ptr [rcx-96]
 vpcmpeqd    ymm2,ymm2,ymm12
 vpblendvb   ymm7,ymm4,ymm7,ymm2
 vpmaxud     ymm2,ymm12,ymmword ptr [rcx-64]
 vpcmpeqd    ymm3,ymm3,ymm13
 vpblendvb   ymm8,ymm4,ymm8,ymm3
 vpmaxud     ymm3,ymm13,ymmword ptr [rcx-32]
 vpsubd      ymm4,ymm4,ymm9
 vpcmpeqd    ymm10,ymm0,ymm10
 vpblendvb   ymm5,ymm4,ymm5,ymm10
 vpcmpeqd    ymm11,ymm1,ymm11
...
LOOP_END:
 ...
 vpmaxud     ymm10,ymm0,ymmword ptr [rdx-256]
 vpmaxud     ymm11,ymm1,ymmword ptr [rdx-224]
 vpmaxud     ymm12,ymm2,ymmword ptr [rdx-192]
 vpmaxud     ymm13,ymm3,ymmword ptr [rdx-160]
 vpcmpeqd    ymm0,ymm0,ymm10
 vpblendvb   ymm5,ymm4,ymm5,ymm0
 vpmaxud     ymm0,ymm10,ymmword ptr [rdx-128]
 vpcmpeqd    ymm1,ymm1,ymm11
 vpblendvb   ymm6,ymm4,ymm6,ymm1
 vpmaxud     ymm1,ymm11,ymmword ptr [rdx-96]
 vpcmpeqd    ymm2,ymm2,ymm12
 vpblendvb   ymm7,ymm4,ymm7,ymm2
 vpmaxud     ymm2,ymm12,ymmword ptr [rdx-64]
 vpcmpeqd    ymm3,ymm3,ymm13
 vpblendvb   ymm8,ymm4,ymm8,ymm3
 vpmaxud     ymm3,ymm13,ymmword ptr [rdx-32]
 vpsubd      ymm4,ymm4,ymm9
 vpcmpeqd    ymm13,ymm3,ymm13
 vpblendvb   ymm8,ymm4,ymm8,ymm13
 ...
 add         rsp,104
 ret
AsmFastMaxIdxU32 ENDP

_TEXT$AsmFastMaxIdxU32 ENDS
