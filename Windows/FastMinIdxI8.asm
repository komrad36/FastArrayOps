_TEXT$AsmFastMinIdxI8 SEGMENT ALIGN(64)

AsmFastMinIdxI8 PROC
 sub		 rsp,200
...
CASE_192:
 vpminsb     ymm0,ymm1,ymmword ptr [rcx-192]
 vpcmpeqb    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubb		 ymm4,ymm4,ymm2
CASE_160:
 vpminsb     ymm1,ymm0,ymmword ptr [rcx-160]
 vpcmpeqb    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 vpsubb		 ymm4,ymm4,ymm2
CASE_128:
 vpminsb     ymm0,ymm1,ymmword ptr [rcx-128]
 vpcmpeqb    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubb		 ymm4,ymm4,ymm2
CASE_96:
 vpminsb     ymm1,ymm0,ymmword ptr [rcx-96]
 vpcmpeqb    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 vpsubb		 ymm4,ymm4,ymm2
CASE_64:
 vpminsb     ymm0,ymm1,ymmword ptr [rcx-64]
 vpcmpeqb    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubb		 ymm4,ymm4,ymm2
CASE_32:
 vpminsb     ymm1,ymm0,ymmword ptr [rcx-32]
 vpcmpeqb    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 lea		 ecx,[rdx-32]
 vmovd		 xmm4,ecx
 ...
 vpminsb     ymm0,ymm1,ymmword ptr [r9-32]
 vpcmpeqb    ymm1,ymm0,ymm1
...
CASE_16:
 ...
 vpminsb     xmm0,xmm1,xmmword ptr [r9-16]
 vpcmpeqb    xmm1,xmm0,xmm1
...
LOOP_TOP:
 ...
 vpminsb     ymm0,ymm4,ymmword ptr [rcx-128]
 vpminsb     ymm1,ymm5,ymmword ptr [rcx-96]
 vpminsb     ymm2,ymm6,ymmword ptr [rcx-64]
 vpminsb     ymm3,ymm7,ymmword ptr [rcx-32]
...
LOOP_END:
 ...
 vpminsb     ymm0,ymm4,ymmword ptr [rdx-128]
 vpminsb     ymm1,ymm5,ymmword ptr [rdx-96]
 vpminsb     ymm2,ymm6,ymmword ptr [rdx-64]
 vpminsb     ymm3,ymm7,ymmword ptr [rdx-32]
 vpcmpeqb    ymm4,ymm0,ymm4
 vpcmpeqb    ymm5,ymm1,ymm5
 vpcmpeqb    ymm6,ymm2,ymm6
 vpcmpeqb    ymm7,ymm3,ymm7
...
INNER_LOOP_END:
 ...
 vpminsb	 ymm1,ymm0,ymmword ptr [rsp+160]
 vpcmpeqb    ymm0,ymm0,ymm1
 ...
 vpminsb	 ymm0,ymm1,ymmword ptr [rsp+160]
 vpcmpeqb    ymm1,ymm0,ymm1
 vpunpcklbw  ymm1,ymm1,ymm1
...
AsmFastMinIdxI8 ENDP

_TEXT$AsmFastMinIdxI8 ENDS
