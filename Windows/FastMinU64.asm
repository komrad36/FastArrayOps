...
_TEXT$FastMinU64 SEGMENT ALIGN(64)
...
CASE_10:
 ...
 cmova       rax,qword ptr [rdx-80]
CASE_9:
 cmp         rax,qword ptr [rdx-72]
 cmova       rax,qword ptr [rdx-72]
CASE_8:
 cmp         rax,qword ptr [rdx-64]
 cmova       rax,qword ptr [rdx-64]
CASE_7:
 cmp         rax,qword ptr [rdx-56]
 cmova       rax,qword ptr [rdx-56]
CASE_6:
 cmp         rax,qword ptr [rdx-48]
 cmova       rax,qword ptr [rdx-48]
CASE_5:
 cmp         rax,qword ptr [rdx-40]
 cmova       rax,qword ptr [rdx-40]
CASE_4:
 cmp         rax,qword ptr [rdx-32]
 cmova       rax,qword ptr [rdx-32]
CASE_3:
 cmp         rax,qword ptr [rdx-24]
 cmova       rax,qword ptr [rdx-24]
CASE_2:
 cmp         rax,qword ptr [rdx-16]
 cmova       rax,qword ptr [rdx-16]
CASE_1:
