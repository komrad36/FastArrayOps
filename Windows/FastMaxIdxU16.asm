_TEXT$AsmFastMaxIdxU16 SEGMENT ALIGN(64)

AsmFastMaxIdxU16 PROC
 sub         rsp,136
...
CASE_96:
 vpmaxuw     ymm0,ymm1,ymmword ptr [rcx-192]
 vpcmpeqw    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubw      ymm4,ymm4,ymm2
CASE_80:
 vpmaxuw     ymm1,ymm0,ymmword ptr [rcx-160]
 vpcmpeqw    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 vpsubw      ymm4,ymm4,ymm2
CASE_64:
 vpmaxuw     ymm0,ymm1,ymmword ptr [rcx-128]
 vpcmpeqw    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubw      ymm4,ymm4,ymm2
CASE_48:
 vpmaxuw     ymm1,ymm0,ymmword ptr [rcx-96]
 vpcmpeqw    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 vpsubw      ymm4,ymm4,ymm2
CASE_32:
 vpmaxuw     ymm0,ymm1,ymmword ptr [rcx-64]
 vpcmpeqw    ymm1,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm1
 vpsubw      ymm4,ymm4,ymm2
CASE_16:
 vpmaxuw     ymm1,ymm0,ymmword ptr [rcx-32]
 vpcmpeqw    ymm0,ymm0,ymm1
 vpblendvb   ymm3,ymm4,ymm3,ymm0
 lea         ecx,[rdx-16]
 vmovd       xmm4,ecx
 ...
 vpmaxuw     ymm0,ymm1,ymmword ptr [r9-32]
 vpcmpeqw    ymm1,ymm0,ymm1
 ...
 ret
CASE_8:
 vpmaxuw     xmm1,xmm0,xmmword ptr [rcx]
 ...
 vpmaxuw     xmm0,xmm1,xmmword ptr [r9-16]
 vpcmpeqw    xmm1,xmm0,xmm1
...
CASE_6:
 ...
 cmovb       r10w,word ptr [r9-12]
 cmovb       eax,ecx
CASE_5:
 lea         ecx,[rdx-5]
 cmp         r10w,word ptr [r9-10]
 cmovb       r10w,word ptr [r9-10]
 cmovb       eax,ecx
CASE_4:
 lea         ecx,[rdx-4]
 cmp         r10w,word ptr [r9-8]
 cmovb       r10w,word ptr [r9-8]
 cmovb       eax,ecx
CASE_3:
 lea         ecx,[rdx-3]
 cmp         r10w,word ptr [r9-6]
 cmovb       r10w,word ptr [r9-6]
 cmovb       eax,ecx
CASE_2:
 lea         ecx,[rdx-2]
 cmp         r10w,word ptr [r9-4]
 cmovb       r10w,word ptr [r9-4]
 cmovb       eax,ecx
CASE_1:
 lea         ecx,[rdx-1]
...
CASE_LARGE:
 ...
 vpmaxuw     ymm0,ymm10,ymmword ptr [rcx+128]
 vpmaxuw     ymm1,ymm11,ymmword ptr [rcx+160]
 vpmaxuw     ymm2,ymm12,ymmword ptr [rcx+192]
 vpmaxuw     ymm3,ymm13,ymmword ptr [rcx+224]
...
LOOP_TOP:
 vpmaxuw     ymm10,ymm0,ymmword ptr [rcx-256]
 vpmaxuw     ymm11,ymm1,ymmword ptr [rcx-224]
 vpmaxuw     ymm12,ymm2,ymmword ptr [rcx-192]
 vpmaxuw     ymm13,ymm3,ymmword ptr [rcx-160]
 vpcmpeqw    ymm0,ymm0,ymm10
 vpblendvb   ymm5,ymm4,ymm5,ymm0
 vpmaxuw     ymm0,ymm10,ymmword ptr [rcx-128]
 vpcmpeqw    ymm1,ymm1,ymm11
 vpblendvb   ymm6,ymm4,ymm6,ymm1
 vpmaxuw     ymm1,ymm11,ymmword ptr [rcx-96]
 vpcmpeqw    ymm2,ymm2,ymm12
 vpblendvb   ymm7,ymm4,ymm7,ymm2
 vpmaxuw     ymm2,ymm12,ymmword ptr [rcx-64]
 vpcmpeqw    ymm3,ymm3,ymm13
 vpblendvb   ymm8,ymm4,ymm8,ymm3
 vpmaxuw     ymm3,ymm13,ymmword ptr [rcx-32]
 vpsubw      ymm4,ymm4,ymm9
 vpcmpeqw    ymm10,ymm0,ymm10
 vpblendvb   ymm5,ymm4,ymm5,ymm10
 vpcmpeqw    ymm11,ymm1,ymm11
...
LOOP_END:
 ...
 vpmaxuw     ymm10,ymm0,ymmword ptr [rdx-256]
 vpmaxuw     ymm11,ymm1,ymmword ptr [rdx-224]
 vpmaxuw     ymm12,ymm2,ymmword ptr [rdx-192]
 vpmaxuw     ymm13,ymm3,ymmword ptr [rdx-160]
 vpcmpeqw    ymm0,ymm0,ymm10
 vpblendvb   ymm5,ymm4,ymm5,ymm0
 vpmaxuw     ymm0,ymm10,ymmword ptr [rdx-128]
 vpcmpeqw    ymm1,ymm1,ymm11
 vpblendvb   ymm6,ymm4,ymm6,ymm1
 vpmaxuw     ymm1,ymm11,ymmword ptr [rdx-96]
 vpcmpeqw    ymm2,ymm2,ymm12
 vpblendvb   ymm7,ymm4,ymm7,ymm2
 vpmaxuw     ymm2,ymm12,ymmword ptr [rdx-64]
 vpcmpeqw    ymm3,ymm3,ymm13
 vpblendvb   ymm8,ymm4,ymm8,ymm3
 vpmaxuw     ymm3,ymm13,ymmword ptr [rdx-32]
 vpsubw      ymm4,ymm4,ymm9
 vpcmpeqw    ymm13,ymm3,ymm13
 vpblendvb   ymm8,ymm4,ymm8,ymm13
...
INNER_LOOP_END:
 ...
 vpmaxuw     ymm0,ymm5,ymmword ptr [rdx-128]
 vpmaxuw     ymm1,ymm6,ymmword ptr [rdx-96]
 vpmaxuw     ymm2,ymm7,ymmword ptr [rdx-64]
 vpmaxuw     ymm3,ymm8,ymmword ptr [rdx-32]
...
AsmFastMaxIdxU16 ENDP

_TEXT$AsmFastMaxIdxU16 ENDS
