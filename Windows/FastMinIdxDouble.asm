_TEXT$AsmFastMinIdxDouble SEGMENT ALIGN(64)

AsmFastMinIdxDouble PROC
 sub         rsp,72
 mov         eax,edx
 cmp         edx,32
 jae         CASE_LARGE
...
CASE_24:
 vminpd      ymm0,ymm1,ymmword ptr [rcx-192]
 vpcmpeqq    ymm1,ymm0,ymm1
 vpblendvb   ymm2,ymm3,ymm2,ymm1
 vpsubq      ymm3,ymm3,ymm5
CASE_20:
 vminpd      ymm1,ymm0,ymmword ptr [rcx-160]
 vpcmpeqq    ymm0,ymm0,ymm1
 vpblendvb   ymm2,ymm3,ymm2,ymm0
 vpsubq      ymm3,ymm3,ymm5
CASE_16:
 vminpd      ymm0,ymm1,ymmword ptr [rcx-128]
 vpcmpeqq    ymm1,ymm0,ymm1
 vpblendvb   ymm2,ymm3,ymm2,ymm1
 vpsubq      ymm3,ymm3,ymm5
CASE_12:
 vminpd      ymm1,ymm0,ymmword ptr [rcx-96]
 vpcmpeqq    ymm0,ymm0,ymm1
 vpblendvb   ymm2,ymm3,ymm2,ymm0
 vpsubq      ymm3,ymm3,ymm5
CASE_8:
 vminpd      ymm0,ymm1,ymmword ptr [rcx-64]
 vpcmpeqq    ymm1,ymm0,ymm1
 vpblendvb   ymm2,ymm3,ymm2,ymm1
 vpsubq      ymm3,ymm3,ymm5
CASE_4:
 vminpd      ymm1,ymm0,ymmword ptr [rcx-32]
 vpcmpeqq    ymm0,ymm0,ymm1
 vpblendvb   ymm2,ymm3,ymm2,ymm0
 lea         ecx,[r9-4]
 vmovd       xmm3,ecx
 ...
 vminpd      ymm0,ymm1,ymmword ptr [rdx-32]
 vpcmpeqq    ymm1,ymm0,ymm1
 vpblendvb   ymm2,ymm3,ymm2,ymm1
...
CASE_LARGE:
 ...
 vminpd      ymm0,ymm8,ymmword ptr [rcx+128]
 vminpd      ymm1,ymm9,ymmword ptr [rcx+160]
 vminpd      ymm2,ymm10,ymmword ptr [rcx+192]
 vminpd      ymm3,ymm11,ymmword ptr [rcx+224]
...
LOOP_TOP:
 vminpd      ymm8,ymm0,ymmword ptr [rcx-256]
 vminpd      ymm9,ymm1,ymmword ptr [rcx-224]
 vminpd      ymm10,ymm2,ymmword ptr [rcx-192]
 vminpd      ymm11,ymm3,ymmword ptr [rcx-160]
 vpcmpeqq    ymm0,ymm0,ymm8
 vpcmpeqq    ymm1,ymm1,ymm9
 vpackssdw   ymm1,ymm0,ymm1
 vpblendvb   ymm5,ymm4,ymm5,ymm1
 vminpd      ymm0,ymm8,ymmword ptr [rcx-128]
 vminpd      ymm1,ymm9,ymmword ptr [rcx-96]
 vpcmpeqq    ymm2,ymm2,ymm10
 vpcmpeqq    ymm3,ymm3,ymm11
 vpackssdw   ymm3,ymm2,ymm3
 vpblendvb   ymm6,ymm4,ymm6,ymm3
 vminpd      ymm2,ymm10,ymmword ptr [rcx-64]
 vminpd      ymm3,ymm11,ymmword ptr [rcx-32]
 vpsubd      ymm4,ymm4,ymm7
 vpcmpeqq    ymm8,ymm0,ymm8
 vpcmpeqq    ymm9,ymm1,ymm9
 vpackssdw   ymm8,ymm8,ymm9
...
LOOP_END:
 ...
 vminpd      ymm8,ymm0,ymmword ptr [rdx-256]
 vminpd      ymm9,ymm1,ymmword ptr [rdx-224]
 vminpd      ymm10,ymm2,ymmword ptr [rdx-192]
 vminpd      ymm11,ymm3,ymmword ptr [rdx-160]
 vpcmpeqq    ymm0,ymm0,ymm8
 vpcmpeqq    ymm1,ymm1,ymm9
 vpackssdw   ymm1,ymm0,ymm1
 vpblendvb   ymm5,ymm4,ymm5,ymm1
 vminpd      ymm0,ymm8,ymmword ptr [rdx-128]
 vminpd      ymm1,ymm9,ymmword ptr [rdx-96]
 vpcmpeqq    ymm2,ymm2,ymm10
 vpcmpeqq    ymm3,ymm3,ymm11
 vpackssdw   ymm3,ymm2,ymm3
 vpblendvb   ymm6,ymm4,ymm6,ymm3
 vminpd      ymm2,ymm10,ymmword ptr [rdx-64]
 vminpd      ymm3,ymm11,ymmword ptr [rdx-32]
 vpsubd      ymm4,ymm4,ymm7
 vpcmpeqq    ymm10,ymm2,ymm10
 vpcmpeqq    ymm11,ymm3,ymm11
 vpackssdw   ymm10,ymm10,ymm11
 ...
 add         rsp,72
 ret
AsmFastMinIdxDouble ENDP

_TEXT$AsmFastMinIdxDouble ENDS
